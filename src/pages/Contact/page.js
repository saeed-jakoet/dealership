  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        try {
          await apiPost("/inbox/new", inboxData);
          backendSuccess = true;
        } catch (err) {
      ...
      try {
        ...
        errorMsg =
          "Email notification failed. " + (err?.text || err?.message || "");
        setSubmitStatus({
          type: "error",
          message: errorMsg,
        });
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Ready to find your perfect vehicle? We're here to help you every
              step of the way.
            </motion.p>
          </motion.div>
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-r ${info.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                    >
